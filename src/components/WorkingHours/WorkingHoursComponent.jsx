...
function WorkingHoursComponent() {
	...
	const getData = () => {
		setLoading(true);
		axios
			.get('https://time-table-manager.herokuapp.com/api/v1/workingDays')
			.then((result) => {
				setLoading(false);
	...
	const onSubmitHandler = (e) => {
		...
		if (
			...
			axios
				.get(
					`https://time-table-manager.herokuapp.com/api/v1/workingDays/type/count/${dayType}`
				)
				.then((res) => {
					console.log(res.dat);
					console.log(dayType);
					...
					if (
						...
						if (!edit) {
							axios
								.post(
									'https://time-table-manager.herokuapp.com/api/v1/workingDays',
									{
										id,
										dayType,
										noOfWorkingDays,
						...
						<div className=''>
							<div className='wh-inputs_block'>
								...
								<input
									...
									value='weekday'
									checked={
										dayType === 'weekday' ? true : false
									}
									onChange={(e) =>
										ondayTypeChange(e.target.value)
									}
								/>{' '}
							</div>
						...
						<div className=''>
							<div className='wh-inputs_block'>
								...
								<input
									...
									value='monday'
									checked={
										dayOfWork === 'monday' ? true : false
									}
									onChange={(e) =>
										onWorkingDayChange(e.target.value)
									}
								/>{' '}
							</div>
							...
							<div className='wh-inputs_block'>
								...
								<input
									...
									value='wednesday'
									checked={
										dayOfWork === 'wednesday' ? true : false
									}
									onChange={(e) =>
										onWorkingDayChange(e.target.value)
									}
