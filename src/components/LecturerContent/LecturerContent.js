            ...
            <div className="">
                ...
                <div className="d-flex ">
                    ...
                    <div id="faculty-container">
                        ...
                        <div className="">
                            <select defaultValue="Computing" className="custom-select" id="faculty-select">
                    ...
                    <div id="center-container">
                        ...
                        <div className="">
                            <select defaultValue="Malabe" className="custom-select" id="center-select">
                    ...
                    <div id="level-container">
                        ...
                        <div className="">
                            <select defaultValue="Lecturer" className="custom-select" id="level-select">
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <div id="department-container">
                        ...
                        <div className="">
                            <select defaultValue="Department Of Information Technology" className="custom-select" id="department-select" >
                    ...
                    <div id="building-container">
                        ...
                        <div className="">
                            <select defaultValue="Main Building" className="custom-select" id="building-select">
                    ...
                    <div id="rank-container">
                        ...
                        <input id="building-input" readOnly="readOnly" />
                    </div>
