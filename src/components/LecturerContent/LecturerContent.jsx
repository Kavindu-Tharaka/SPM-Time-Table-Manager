...
const LecturerContent = () => {
	...
	const deleteLecturer = (rowID) => {
		axios
			.delete(
				`https://time-table-manager.herokuapp.com/api/v1/lecturers/${rowID}`
			)
			.then((res) => {
				setLecturerDetails(
				...
				store.addNotification(
					buildToast('danger', '', 'Lecturer deleted')
				);
			})
	...
	const onSubmit = (e) => {
		...
		axios
			.post('https://time-table-manager.herokuapp.com/api/v1/lecturers', {
				name,
				faculty,
				center,
				level,
		...
		// }
		// else {
		//     axios.patch(`https://time-table-manager.herokuapp.com/api/v1/lecturers/${id}`, {
		//         name,
		//         faculty,
		//         center,
		//         level,
