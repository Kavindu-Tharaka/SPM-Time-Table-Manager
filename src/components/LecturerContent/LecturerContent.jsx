...
const LecturerContent = () => {
	...
	const deleteLecturer = (rowID) => {
		axios
			...
			.then((res) => {
				setLecturerDetails(
					lecturerDetails.filter((lec) => {
						return lec._id !== rowID;
					})
				);
			})
	...
	const onSubmit = (e) => {
		...
		if (name === '' && employeeId === '') {
			...
			axios
				.post('http://localhost:8000/api/v1/lecturers', {
					name,
					faculty,
					center,
					level,
			...
			axios
				.patch(`http://localhost:8000/api/v1/lecturers/${id}`, {
					name,
					faculty,
					center,
					level,
		...
		},
		{
			...
			cell: (row) => (
				<div className='d-flex'>
					<button
						id='btn-edit'
						className='btn rounded-circle border-none btn-sm'
						onClick={() => updateLecturer(row)}
					>
					...
					<button
						id='btn-remove'
						className='btn rounded-circle border-none btn-sm'
						onClick={() => deleteLecturer(row._id)}
					>
				...
				<form onSubmit={onSubmit}>
						...
						<div id='faculty-container'>
							...
							<div className=''>
								...
								>
									...
									<option value='Humanities & Scienes'>
										Humanities & Scienes
									</option>
									<option value='Graduate Studies & Research'>
									...
									<option value='School of Hospitality & Culinary'>
						...
						<div id='center-container'>
							...
							<div className=''>
								...
								>
									...
									<option value='Metro Campus'>
										Metro Campus
									</option>
									<option value='SLIIT Academy'>
										SLIIT Academy
									</option>
					...
					<div className='d-flex justify-content-between'>
						...
						<div id='department-container'>
							...
							<div className=''>
								...
								>
									...
									<option value='Department Of COMPUTER SCIENCE & SOFTWARE ENGINEERING'>
										Department Of COMPUTER SCIENCE &
										SOFTWARE ENGINEERING
									</option>
									<option value='Department Of COMPUTER SYSTEMS ENGINEERING'>
									...
									<option value='Department Of MATERIALS ENGINEERING'>
										Department Of MATERIALS ENGINEERING
									</option>
									<option value='Department Of CIVIL ENGINEERING'>
										Department Of CIVIL ENGINEERING
									</option>
									<option value='Department Of QUANTITY SURVEYING'>
										Department Of QUANTITY SURVEYING
									</option>
									<option value='SLIIT SCHOOL Of ARCHITECTURE'>
										SLIIT SCHOOL Of ARCHITECTURE
									</option>
								</select>
							</div>
						</div>
						<div id='building-container'>
							...
							<div className=''>
								...
								>
									...
									<option value='Buisnees Faculty Building'>
										Buisnees Faculty Building
									</option>
						...
						<div id='rank-container'>
							...
							<input id='rank-input' readOnly='readOnly' />
						</div>
					</div>
					{/* second row ends*/}
					...
					<div className='d-flex justify-content-end mt-2'>
						<button
							id='lec-insert'
							type='submit'
							className='btn btn-primary wk-submit-button'
						>
							{' '}
							{update ? 'Edit' : 'Add'}{' '}
						</button>
